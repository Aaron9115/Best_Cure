...
public UserModel(String first_name, String last_name, String user_name, String user_email, String gender,
	String phone_number, String user_password) {

this(first_name, last_name, user_name, user_email, gender, phone_number, user_password, "user");
	}

	public UserModel(String first_name, String last_name, String user_name, String user_email, String gender,
			String phone_number, String user_password, String user_role) {
		super();
